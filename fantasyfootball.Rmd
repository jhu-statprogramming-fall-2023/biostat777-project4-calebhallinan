...
data_players_final_2 = data_players |> 
  ...
  # init plot
ggplot(data = data_players_final_2, aes(x = playerscoredifference.x, y = fct_reorder(PlayerName,
                                        desc(playerscoredifference.x)), fill = PlayerName)) +
  # columns
  geom_col() +
  # xlim
  ...
  labs(
    ...
    projected store for all weeks combined.", width= 110)) +
   # add colors
...
ggplot(data = data_players_final, aes(x = playerscoredifference.x, y = fct_reorder(PlayerName, playerscoredifference.x),
                                      fill = PlayerName)) +
  geom_col() +
  xlim(min(data_players$playerscoredifference.x), max(data_players$playerscoredifference.x)) +
    # add labels
...
<!-- Will add analysis of fantasy football here  -->
